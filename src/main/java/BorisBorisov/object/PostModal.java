...
public class PostModal {
    ...
    public void deletePost() {
        WebElement deletePost= modalElement.findElement(By.xpath("//label[@class='delete-ask']"));
        deletePost.click();
    }

    public void confirmDelete() {
        WebElement confirmDelete = modalElement.findElement(By.xpath("//button[@class='btn btn-primary btn-sm']"));
        confirmDelete.click();
    }

    public void privatePost() {
        WebElement privatePost = modalElement.findElement(By.xpath("//i[@class='fas fa-lock ng-star-inserted']"));
        privatePost.click();
    }
}
